...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="${pageContext.request.contextPath}/admin/product">Product</a>
                        <a class="collapse-item" href="${pageContext.request.contextPath}/admin/news">News</a>
                    </div>
                </div>
            </li>
            ...
            <div class="sidebar-card">
                <img class="sidebar-card-illustration mb-2" src="resources/admin/resources/admin/img/undraw_rocket.svg" alt="">
    ...
    <script src="resources/admin/rejs/sb-admin-2.min.js"></script>
