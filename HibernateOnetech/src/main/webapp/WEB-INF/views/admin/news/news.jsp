								...
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										<c:forEach var="news" items="${allnews}">
											<tr>
												<td><p
														style="color: black; font-size: 14px; text-align: center">${news.getId_news() }</p></td>
												<td><p
														style="color: black; font-size: 14px; text-align: center">${news.getName_news() }</p></td>
												<td><img
													src="${pageContext.request.contextPath}/resources/news/${news.getImages_news() }"
													alt="Trang web công nghệ"
													style="width: 100px; height: 100px;"></td>
												<td>${news.getDescription_news() }</td>
												<td><p
														style="color: black; font-size: 14px; text-align: center; margin-top: 20px;">
														<a href="<c:url value='/edit_news/${news.getId_news() }'/>" 
															class="btn"><i class="fa fa-edit"></i></a>
													</p></td>
												<td><p
														style="color: black; font-size: 14px; text-align: center; margin-top: 20px;">
														<a href="<c:url value='/remove_news/${news.getId_news() }' />"
															class="btn"><i class="fas fa-trash-alt"></i></a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
								<a href="${pageContext.request.contextPath}/admin/addnews"  type="button">Thêm</a>
							</div>
						</div>
					</div>
