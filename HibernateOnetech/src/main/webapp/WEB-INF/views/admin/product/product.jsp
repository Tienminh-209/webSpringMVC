								...
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										<c:forEach var="product" items="${allproduct}">
											<tr>
												<td><p
														style="color: black; font-size: 14px; text-align: center">${product.getId() }</p></td>
												<td><p
														style="color: black; font-size: 14px; text-align: center">${product.getTitle() }</p></td>
												<td><img
													src="${pageContext.request.contextPath}/resources/${product.getImage() }"
													alt="Trang web công nghệ"
													style="width: 100px; height: 100px;"></td>
												<td><fmt:formatNumber value="${product.getPrice() }"
												...
												<td><p
														style="color: black; font-size: 14px; text-align: center; margin-top: 20px;">
														<a href="<c:url value='/remove/${product.getId() }' />"
															class="btn"><i class="fas fa-trash-alt"></i></a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
								<a href="${pageContext.request.contextPath}/admin/addproduct"  type="button">Thêm</a>
							</div>
						</div>
					</div>
