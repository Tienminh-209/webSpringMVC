                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                             <h4 class="text-center" style="color: red;">CẬP NHẬT SẢN PHẨM</h4>
                              <div class="panel-body">
										<form:form action="${pageContext.request.contextPath}/editproduct" method="POST" commandName="product">
										
										<div class="form-group">
											 <label></label>
											 <form:hidden required="true" class="form-control" path="id"/>
											</div>
