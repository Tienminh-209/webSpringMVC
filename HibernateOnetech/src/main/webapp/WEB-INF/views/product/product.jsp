		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="resources/${product.getImage() }"><img src="resources/${product.getImage() }" alt=""></li>
						<li data-image="resources/${product.getImage() }"><img src="resources/${product.getImage() }" alt=""></li>
						<li data-image="resources/${product.getImage() }"><img src="resources/${product.getImage() }" alt=""></li>
					</ul>
				</div>
				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_text"><p>${product.getDescription() }</p></div>
						<div class="order_info d-flex flex-row">
							<form action="#">
								...
								<div class="button_container">
									<a href="AddCart/${product.getId()}" type="button" class="button cart_button" type="button">Add to Cart</a>
      	...
      	<jsp:include page ="related_product.jsp"></jsp:include>
	<div class="brands">
		<div class="container">
			<div class="row">
				<div class="col">
