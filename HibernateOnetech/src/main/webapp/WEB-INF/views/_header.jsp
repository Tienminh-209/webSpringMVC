			...
			<div class="row">
				<div class="col d-flex flex-row">
					...
					<div class="top_bar_contact_item">
						...
						<a href="mailto:fastsales@gmail.com">buiminhtien2025@gmail.com</a>
					</div>
					<div class="top_bar_content ml-auto">
						<div class="top_bar_menu">
							<ul class="standard_dropdown top_bar_dropdown">
								<li><a href="#">Anh<i class="fas fa-chevron-down"></i></a>
									<ul>
										<li><a href="#">Ý</a></li>
										<li><a href="#">TBN</a></li>
										<li><a href="#">Nhật Bản</a></li>
									</ul></li>
								<li><a href="#">$ Mỹ dollar<i
						...
						<div class="top_bar_user">
							...
							<c:if test="${empty sessionScope.Login}">
								<div>
									<a href="${pageContext.request.contextPath}/dang-ki">Đăng ký</a>
								</div>
							</c:if>
							...
							<div class="header_search_form_container">
								<form action="#" class="header_search_form clearfix">
									<input type="search" required="required"
										class="header_search_input" placeholder="Tìm kiếm sản phẩm...">
							...
							<div
								...
								<div class="cart_content">
									...
									<div class="cart_price">
										<fmt:formatNumber value="${Total_Price_Cart}" type="number"
											maxIntegerDigits="14" />
									</div>
								</div>
							</div>
					...
					<div class="main_nav_content d-flex flex-row">
						...
						<div class="main_nav_menu ml-auto">
							<ul class="standard_dropdown main_nav_dropdown">
								<li><a href="http://localhost:8080/HibernateOnetech/">Trang
										chủ<i class="fas fa-chevron-down"></i>
								</a></li>
								<li class="hassubs"><a href="${pageContext.request.contextPath}/news">Tin tức<i
										class="fas fa-chevron-down"></i></a>
									</li>
								<li class="hassubs"><a href="#">Thương Hiệu Nổi Tiếng<i
										class="fas fa-chevron-down"></i></a>
									<ul>
										<li><a href="#">Danh mục<i
												class="fas fa-chevron-down"></i></a>
											<ul>
												<li><a href="#">Danh mục<i
								...
								<li class="hassubs"><a href="#">Trang<i
										class="fas fa-chevron-down"></i></a>
									<ul>
										<li><a href="${pageContext.request.contextPath}/admin">Admin<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="product.html">Sản Phẩm<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="blog.html">Bài Viết<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="blog_single.html">Đăng Bài Viết<i
												class="fas fa-chevron-down"></i></a></li>
										<li><a href="regular.html">Đăng Thường Xuyên<i
												class="fas fa-chevron-down"></i></a></li>
				...
				<div class="col">
					...
					<div class="page_menu_content">
						...
						<ul class="page_menu_nav">
							...
							<li class="page_menu_item"><a href="#">Trang chủ<i
									class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item has-children"><a href="#">Giao
									dịch nhanh<i class="fa fa-angle-down"></i>
							</a>
								<ul class="page_menu_selection">
									<li><a href="#">Siêu giao dịch<i
											class="fa fa-angle-down"></i></a></li>
									<li class="page_menu_item has-children"><a href="#">Danh
											Mục<i class="fa fa-angle-down"></i>
									</a>
										<ul class="page_menu_selection">
							...
							<li class="page_menu_item has-children"><a href="#">Thương
									hiệu nổi bật<i class="fa fa-angle-down"></i>
							</a>
								<ul class="page_menu_selection">
									<li><a href="#">Thương hiệu nổi bật<i
											class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
							...
							<li class="page_menu_item has-children"><a href="#">Trending
								...
								<ul class="page_menu_selection">
									<li><a href="#">Phong cách thịnh hành<i
											class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
									<li><a href="#">Danh Mục<i class="fa fa-angle-down"></i></a></li>
